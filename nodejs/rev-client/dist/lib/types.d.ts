export declare type ApprovalStatus = 'Approved' | 'PendingApproval' | 'Rejected' | 'RequiresApproval' | 'SubmittedApproval';
export declare type VideoType = "Live" | "Vod";
export declare type EncodingType = "H264" | "HLS" | "HDS" | "H264TS" | "Mpeg4" | "Mpeg2" | "WM" | "Flash" | "RTP";
export declare type VideoStatusEnum = "NotUploaded" | "Uploading" | "UploadingFinished" | "NotDownloaded" | "Downloading" | "DownloadingFinished" | "DownloadFailed" | "Canceled" | "UploadFailed" | "Processing" | "ProcessingFailed" | "ReadyButProcessingFailed" | "RecordingFailed" | "Ready";
export declare type VideoAccessControl = "AllUsers" | "Public" | "Private" | "Channels";
export declare type AccessControlEntityType = 'User' | 'Group' | 'Team' | 'Role';
export declare type ExpirationAction = 'Delete' | 'Inactivate';
